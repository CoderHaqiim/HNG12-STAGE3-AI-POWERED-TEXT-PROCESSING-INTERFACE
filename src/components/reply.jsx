...
export default function Reply({reply}) {
  ...
  return (
    <div className='w-full h-auto flex justify-start gap-[10px]'>
      ...
      <div className={`py-[10px] text-[1.1rem] px-[10px] min-w-[200px] max-w-[300px] font-[400] rounded-[10px] shadow-shadow1 leading-[1.2] break-all bg-[#5b046322] lg:max-w-[500px]`}>
        {
          <p>{reply}</p>
        }
