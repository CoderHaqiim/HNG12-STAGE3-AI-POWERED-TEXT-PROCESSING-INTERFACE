  ...
  return (
    <div className='content relative w-full h-auto flex-1 overflow-y-scroll'>
      <div className={`${dialogue?.length >= 1? "hidden" : "flex"} absolute w-full h-full items-center flex-col justify-center`}>
        <img className='w-[100px] h-[100px]' src="/robot.svg" alt="robot image" />
        <h1 className='text-center text-[2rem] font-bold mt-[20px] text-[#555555]'>Welcome to Textify</h1>
        <p className='text-center word-break text-[#888888]'>Enter your text in the input below to translate or summarize them.</p>
      </div>
        <Container>
